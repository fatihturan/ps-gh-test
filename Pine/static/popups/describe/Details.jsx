...
class Details extends React.Component {
  ...
  loadDetails() {
    fetchJson(`${BASE_DESCRIBE_URL}/${this.props.dataId}/${encodeURIComponent(this.props.selected.name)}`, detailData => {
      const newState = {
        error: null,
        details: null,
        code: null,
  ...
  loadOutliers() {
    ...
    fetchJson(`/dtale/outliers/${this.props.dataId}/${encodeURIComponent(this.props.selected.name)}`, outlierData => {
