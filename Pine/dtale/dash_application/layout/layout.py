    ...
    return """
        ...
        <html>
            <head>
                {webroot_html}
                {metas}
                <title>Pine Charts</title>
                <link rel="shortcut icon" href="{favicon_path}">
                {css}
            </head>
            <body>
                <div class="container-fluid charts">
                <!-- Removing Charts header -->
                    <!-- <div class="row" style="margin: 0">
                        <div class="col-auto">
                            <header>
                                <span class="title-font">Pine</span>
...
DEFAULT_CSALES = {"heatmap": JET, "maps": REDS, "3d_Scatter": PINECONTINUOUS, "surface": YLGRBL}
...
def charts_layout(df, settings, **inputs):
    ...
    query_placeholder = "Enter query (ex: Season == '2020-2021')"
                        ...
                        html.Div(
                            [
                                ...
                                build_input(
                                    ...
                                    dcc.Dropdown(
                                        id="top-bars",
                                        options=[build_option(v) for v in [5, 10, 15, 20, 25, 50]],
